...
from Airways.items import AirwaysItem
import re


class AirwaysSpider(Spider):
    name = "AirwaysSpider"
    allowed_urls = ['https://www.airlinequality.com/']
    start_urls = ['https://www.airlinequality.com/airline-reviews/singapore-airlines/page/' + str(i) for i in range(200)]
